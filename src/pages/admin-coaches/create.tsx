...
import { adminCoachApi, adminPersonApi, type CreateCoachDto, type Person } from '@/api/admin'
...
export function CreateCoachPage() {
  ...
  const [formData, setFormData] = useState<CreateCoachDto>({
    person_id: '',
    gym_id: undefined,
  })
  ...
  const handleSubmit = async () => {
    ...
    try {
      setSaving(true)
      await adminCoachApi.create(formData)
